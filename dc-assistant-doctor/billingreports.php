  ...
  <div class="page-content p-5" id="main">
    ...
    <div class="container pt-3 pb-5 bg-light rounded shadow-lg">
      ...
      <ul class="nav nav-pills nav-fill">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="billingreports.php">Billing</a>
        </li>
    ...
    <div id = "content">
      <div class="row pt-1">
        <div class="col">
        <h1 style="color: black;"><i class="fas fa-copy mr-3"></i>Billing Reports</h1>
      ...
      <div class="table-responsive">
        <table  class="table table-striped table-bordered">
         ...
         <th>Status</th> 
          ...
          <tbody>
            <tr>
          <?php showBillingReports($conn,$clinic); ?>
          </tbody>
        </table>
      </div>
