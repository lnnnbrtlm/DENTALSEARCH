...
move_uploaded_file($_FILES["logo"]["tmp_name"], "include/profile pictures/".$_FILES["logo"]["name"]);

$sql = "INSERT INTO clinic_tbl(`user_id`,clinic_name,clinic_contact,clinic_email,clinic_desc,clinic_address,start_time, end_time,logo)
        VALUES ('$user_id','$name','$contactno','$email','$desc','$address','$start_time','$end_time','$profile_img')";
if (mysqli_query($conn, $sql)) {
        
    // after adding, find it 
    $sqlFind = "SELECT clinic_id FROM clinic_tbl 
                WHERE clinic_name = '$name' AND clinic_contact='$contactno' 
                AND clinic_email = '$email' AND clinic_desc = '$desc'
                AND clinic_address= '$address' 
