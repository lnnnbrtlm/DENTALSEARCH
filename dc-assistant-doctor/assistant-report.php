  ...
  <div class="page-content p-5" id="main">
    ...
    <div class="container pt-3 pb-5 bg-light rounded shadow-lg">
      ...
      <ul class="nav nav-pills nav-fill">
        <li class="nav-item">
          <a class="nav-link active" href="assistant-report.php">Appointment</a>
        </li>
    ...
    <div id = "content">
      <div class="row pt-1">
        <div class="col">
        <h1 style="color: black;"><i class="fas fa-copy mr-3"></i>Appointment Reports </h1>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class=row>
                ...
                <div class="col">
                  <p><b>Appointment Status:</b> <span class="badge badge-secondary">Unconfirmed</span>
                  </p>
                  <label for="DTPicker"><b>Appointment Start:</b></label>
                  <input type="DTPicker" class="form-control" placeholder="DATETIMEPICKER" id="DTPicker">
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-info" data-dismiss="modal">Calendar</button>
