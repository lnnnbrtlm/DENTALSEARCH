...
<head>
  <title>Clinic Feedbacks | Dental Track</title>
  ...
  <div class="page-content p-5" id="content">
    ...
    <div class="container pt-3 pb-3 bg-light rounded shadow-lg">
      ...
      <ul class="nav nav-pills nav-fill">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="admin-clinic.php">Feedbacks</a>
        </li>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Feedback [Dental Clinic Name]</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <p><strong>Dental Clinic Name:</strong><br>
        Dental Clinic<br><br>
        <strong>Ratings:</strong><br>
        4<br><br>
        <strong>Feedback:</strong><br>
        Lorem Ipsum asdasdasasdasd<br></p>
