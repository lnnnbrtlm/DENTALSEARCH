        ...
        <div class="col-5 ">
            ...
            <table class="table table-borderless text-center">
                <tr>
                    ...
                    <?php
                    for ($i = 18; $i > 10; $i--) {
                        echo '<td><input class="temp"  id="upper1" type="text" value="' . showToothPro($conn, $_GET['ref_no'], $i) . '" readonly></td>';
                    }
                    ?>
                ...
                <tr>
                    ...
                    <?php
                    for ($i = 18; $i > 10; $i--) {
                        echo '<td><input class="temp"  id="upper1" type="text" value="' . showToothCond($conn, $_GET['ref_no'], $i) . '" readonly></td>';
                    }
                    ?>
        ...
        <div class="col-5">
            ...
            <table class="table table-borderless text-center">
                ...
                <tr>
                    ...
                    <?php
                    for ($i = 48; $i > 40; $i--) {
                        echo '<td><input class="temp"  id="lower1" type="text" value="' . showToothCond($conn, $_GET['ref_no'], $i) . '" readonly></td>';
                    }
                    ?>
                </tr>
                <tr>
                    ...
                    <?php
                    for ($i = 48; $i > 40; $i--) {
                        echo '<td><input class="temp"  id="lower1" type="text" value="' . showToothPro($conn, $_GET['ref_no'], $i) . '" readonly></td>';
                    }
                    ?>
                </tr>
