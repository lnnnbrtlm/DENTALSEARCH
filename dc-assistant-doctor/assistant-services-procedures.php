...
<head>
  <title>Procedures | Data Management</title>
...
?>
  ...
  <div class="page-content p-5" id="content">
    ...
    <ul class="nav nav-pills nav-fill">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="assistant-services-procedures.php">Procedures</a>
                </li>
                <li class="nav-item">
 ...
 <form action="include/updateProcedure.php" method="POST">
          <!-- Modal body -->
          <div class="modal-body">
         
            <div class="input-group mb-3">
              <div class="input-group-prepend">
                <label class="input-group-text" for="inputGroupSelect01">Selected Procedures</label>
              </div>
              <select class="custom-select" id="inputGroupSelect01" name="up_id">
                      <option selected disabled>Choose...</option>
                      <?php showProcedureDD($conn); ?>
              </select>
            </div>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="Service Name" name="up_procedure" onKeyDown="limitText(this,3);" 
onKeyUp="limitText(this,3)">
              </div>
              <div class="form-group">
                <label for="service">Proceduere</label>
                <input type="text" class="form-control" placeholder="Service Name" name="up_legend" onKeyDown="limitText(this,30);" 
      ...
      <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <form action="include/addProcedure.inc.php" method="POST">
              <div class="form-group">
                <label for="service">Procedure:</label>
                <input type="text" class="form-control" placeholder="Procedure Name" name="procedure" onKeyDown="limitText(this,30);" 
onKeyUp="limitText(this,30)">
              </div>
              <div class="form-group">
                <label for="service">Legend:</label>
                <input type="text" class="form-control" placeholder="Legend" name="legend" onKeyDown="limitText(this,3);" 
onKeyUp="limitText(this,3)">
              </div>
              <div class="form-group">
                <label for="price">Price:</label>
