...
list($appointment_refno,$patient_name,$service_name,$clinic_id,$status,$patient_id,$email,$time) =  showModalPatientConfirmAppointment($conn,$ref_no);
?>
                ...
                <div class="col-4">
                    <div class="card">
                        ...
                        <form method="post" action="#">
							            <input type="hidden" name="dental_type" id="dental_type" value="child"/>
                                <fieldset disabled>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="pid" name="pid" value="<?php echo $patient_id; ?>">
                            ...
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#MedicalHistory">Medical History</button>
                        </div>
                    </div>
                </div>
