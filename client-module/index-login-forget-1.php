    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        try {
           ...
           // $mail->isSMTP();
            ...
            $sql1 = "UPDATE patient_record SET verification_code = '$verification_code' WHERE email='$email'";
            $result1 = mysqli_query($conn, $sql1);
            if ($result1) {
            
                //insert in user tables
                header("Location: index-login-forget-2.php?email=".$email."");
            }else{
...
window.location.href='index-login-forget-2.php';
</script>");
    } else {
    ...
    <div class="d-flex justify-content-center align-items-center login-container">
        ...
        <div class="mb-5"><span class="text-dark mx-1 logo-nav">DENTAL<span style="color:#fd9f35">SEARCH</span></div>
            ...
            <h5 class="pb-2">Forget Password</h5>
                ...
                <p class="mt-3 font-weight-normal">Return to login. <a href="index-login.php"><strong>Back</strong></a></p>
            </form>
