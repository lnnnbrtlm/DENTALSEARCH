...
$sql = "INSERT INTO appointments(clinic_id, service_name,patient_id, patient_name, email, start_time, end_time, appointment_datentime, `status`,`clinic_name`,`notif`)
        VALUES($serviceid, '$finalservicename','$patient_id', '$patient_name', '$email', '$succ', '$endtime', '$datepicker', 'Upcoming','$clinic_name','2')";
...
<p>
Hi  '.$patient_name.', <br>
Your appointment is  <b>successfully booked </b>for '.$finalservicename.' to <u>'.$clinic_name.'</u> on '.$datepicker.' at '.$succ.'.
</p>
</body>
</html>';
$headers .= "FROM: ". $from;
